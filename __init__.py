...
version = '1.0.0' author = 'Srijon Kumar Shill' email = 'theunpredictable157@gmail.com'

from . import recognizer from . import evaluator from . import simulator from . import profiles from . import logger
